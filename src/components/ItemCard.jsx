...
export function ItemCard ({ title, description, date, tags, link }) {
  ...
  return (
    <a href={link} target='_blank' rel='noopener noreferrer' className='flex flex-col justify-center items-center p-4 mb-4 rounded-lg border border-gray-200 hover:border-primary'>
