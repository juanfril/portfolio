export const projects = [
  ...
  },
  {
    title: 'Web3 DEX',
    description:
      'The project is a Decentralized Exchange (DEX) developed using React and TypeScript to provide a seamless user experience in a Web3 environment. The project is organized with NX for efficient workspace management and uses Storybook for component development and documentation, ensuring consistency across desktop and mobile interfaces. Jest is integrated for rigorous testing, ensuring code quality and reliability. Due to confidentiality, I am unable to share a link to this project.',
    link: '',
