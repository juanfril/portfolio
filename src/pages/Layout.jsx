...
export function Layout() {
  return (
    <div className="leading-relaxed text-lg text-slate-400 antialiased selection:bg-emerald-300 selection:text-emerald-900">
      <div className="lg:flex lg:flex-col g:justify-between lg:gap-4">
        ...
        <main className="flex flex-col max-w-screen-md mx-auto">
          ...
          <section id="experience" className="w-full px-4 scroll-mt-24">
            <h2 className="text-xl sm:text-4xl font-bold mt-12 mb-6 text-emerald-600">
              Experience
            </h2>
            {experiences.map((ex, index) => {
              return (
                <ItemCard
                  ...
                  tags={ex.tags}
                  link={ex.link}
                  notAvailableReason={ex.notAvailableReason}
                />
              )
            })}
            <a
            ...
            {projects.map((project, index) => {
              return (
                <ItemCard
                  ...
                  tags={project.tags}
                  link={project.link}
                  notAvailableReason={project.notAvailableReason}
                />
              )
            })}
          </section>
